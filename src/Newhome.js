        ...
        <div>
            ...
            <div className="row row1">
                ...
                <div className="benefits">
                    <LightSpeed right duration={1500} right cascade>
                    <h3>Why get a logo?</h3>
                    </LightSpeed>
                    <LightSpeed right delay={1710} duration={1000} right cascade>
                    <ul style={{ listStyle: "none" }}>
                        ...
                        <li className="benefitstext">
                        Logos Represent You and Your Brand. Anyone would Prefer a Company
                        with a Nice Logo over Another with a Not-so-nice Logo.
                        </li>
                        
                        <li className="benefitstext">
                        Logos have the Power to Influence Sales and Build Huge Brands.
                        Hence, it Becomes very Important to have an Appropriate Logo for
                        your Brand.
                        </li>
                        
                        <li className="benefitstext"> 
                        The Main Benefit of a Good and Unique Logo is that you get a Truly
                        Unique Logo that Stands out and Builds a Professional Brand Name
                        for your Business.
                        </li>
            ...
            <div className="col-md-7">
                ...
                <div className="col-md-5">
                    ...
                    <div className="replybox">
                        <p>
                            My Services Include <span>TOP QUALITY</span> Art Work in Whatever
                            way needed.
                            <br />
